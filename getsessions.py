...
# #def join_text_room(session_id, handle_id, room):
#    """Lists available text rooms."""
#    data = {
#        "janus": "meassage",
#        "transaction": str(uuid.uuid4()),  # Unique transaction ID
...
#                "plugin": "janus.plugin.textroom",
#                "data" : {
#            "textroom": "join",  # This should be a string
#            "room": room,
#            "pin": "",
#            "username": "console",
#            "display": "console",
...
#            return response_data['plugindata']['data']  # Room list
#        else:
#            print(f"Error joining text room {room}: {response_data['error']}")
#    else:
#        print(f"Failed to join text room {room}. Status code: {response.status_code}")
#        print(response.text)
#    return None
#
#def message_text_room(session_id, handle_id, room, message):
#    """Lists available text rooms."""
#    data = {
#        "janus": "message",
#        "transaction": str(uuid.uuid4()),  # Unique transaction ID
...
#    return None
#
#def leave_text_room(session_id, handle_id, room):
#    """Lists available text rooms."""
#    data = {
#        "janus": "message",
#        "transaction": str(uuid.uuid4()),  # Unique transaction ID
